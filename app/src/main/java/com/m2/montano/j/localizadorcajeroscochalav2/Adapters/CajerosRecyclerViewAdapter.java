...
import com.m2.montano.j.localizadorcajeroscochalav2.Fragments.TodosCajerosFragment.ListaTodosCajeros;
 ...
 * specified {@link ListaTodosCajeros}.
 * TODO: Replace the implementation with code for your data type.
 */
public class CajerosRecyclerViewAdapter extends RecyclerView.Adapter<CajerosRecyclerViewAdapter.ViewHolder> {

    private final List<Cajero> mValues;
    private final TodosCajerosFragment.ListaTodosCajeros mListener;

    public CajerosRecyclerViewAdapter(List<Cajero> items, TodosCajerosFragment.ListaTodosCajeros listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void personalizaVista(final CajerosRecyclerViewAdapter.ViewHolder holder, Cajero lugar) {
        holder.mItem = lugar;
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.seleccionarCajero(holder.mItem);
                    //Log.d("prueba","clipp");
                }
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
       public final View mView;
        ...
        @BindView(R.id.valoracion1) RatingBar valoracion;
