...
public class ListaNoConfirmadaViewAdapter$ViewHolder_ViewBinding implements Unbinder {
  private ListaNoConfirmadaViewAdapter.ViewHolder target;

  @UiThread
  public ListaNoConfirmadaViewAdapter$ViewHolder_ViewBinding(ListaNoConfirmadaViewAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ListaNoConfirmadaViewAdapter.ViewHolder target = this.target;
